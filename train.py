...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epoch', help='number of epochs', default=1000, type=int)
    parser.add_argument('--lr', help='optimizer learning rate', default=1e-2, type=float)
    ...
    parser.add_argument('--emb_size', help='word embedding size', default=123, type=int)
    ...
    model.run(train_data, val_data, optimizer)
